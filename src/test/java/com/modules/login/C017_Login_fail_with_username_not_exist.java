...
public class C017_Login_fail_with_username_not_exist extends TestBase {

    @Test(dataProvider = "getDataForTest", description = "Người dùng  thấy thông báo lỗi khi đăng nhập với tên tài khoản không tồn tại")
    public void TC01(Hashtable<String, String> data) {
        ...
        logStep = TestReporter.logStepInfo(logMethod, "Bước #3: Đăng nhập với tên tài khoản không tồn tài và mật khẩu đúng format");
        ...
        logStep = TestReporter.logStepInfo(logMethod, "Bước #3: Kiểm tra cảnh báo đăng nhập");
