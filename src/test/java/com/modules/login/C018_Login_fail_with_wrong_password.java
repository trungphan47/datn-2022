...
public class C018_Login_fail_with_wrong_password extends TestBase {

    @Test(dataProvider = "getDataForTest", description = "Người dùng thấy thông báo lỗi khi đăng nhập sai mật khẩu")
    public void TC01(Hashtable<String, String> data) {
        ...
        logStep = TestReporter.logStepInfo(logMethod, "Bước #3: Đăng nhập với tên tài khoản tồn tài trong database và mật khẩu sai");
