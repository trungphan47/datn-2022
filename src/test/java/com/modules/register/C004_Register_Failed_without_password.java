...
public class C004_Register_Failed_without_password extends TestBase {

    @Test(dataProvider = "getDataForTest", description = "Người dùng thấy thông báo lỗi khi đăng ký mà không nhập mật khẩu")
    public void TC01(Hashtable<String, String> data) {
        ...
        registerPage.checkPasswordAlert(logStep, data.get("Message1"), data.get("Message2"));
    }
}
