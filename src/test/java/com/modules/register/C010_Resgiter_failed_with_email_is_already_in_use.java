...
public class C010_Resgiter_failed_with_email_is_already_in_use extends TestBase {


    @Test(dataProvider = "getDataForTest", description = "Người dùng thấy thông báo lỗi khi đăng ký với tên tài khoản đã tồn tại")
    public void TC01(Hashtable<String, String> data) {
        ...
        Assertion.verifyActualAndExpected(logStep, registerPage.getErrorMessageLabel(), data.get("Message"));
    }
}
