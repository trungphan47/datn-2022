...
public class C002_RegisterSuccess extends TestBase {

    @Test(dataProvider = "getDataForTest", description = "Người dùng có thể đăng ký thành công với đầy đủ các thông tin hợp lệ")
    public void TC01(Hashtable<String, String> data) {
        ...
        logStep = TestReporter.logStepInfo(logMethod, "Bước #5: Xác minh người dùng đã đăng ký thành công");
        Assertion.verifyActualAndExpected(logStep, registerPage.getRegisterSuccessLabel(), data.get("SuccessMessage"));
