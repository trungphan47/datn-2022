...
public class C006_Register_Failed_with_wrong_format_userName extends TestBase {

    @Test(dataProvider = "getDataForTest", description = "Người dùng thấy thông báo lỗi khi đăng ký với tên tài khoản không đúng định dạng")
    public void TC01(Hashtable<String, String> data) {
        ...
        logStep = TestReporter.logStepInfo(logMethod, "Bước #4: Kiểm tra nhắc nhở khi đăng ký với tên tài khoản không đúng định dạng");
        registerPage.checkWarningMsgForEmail(logStep, data.get("Message1"), data.get("Message2"));
    }
}
