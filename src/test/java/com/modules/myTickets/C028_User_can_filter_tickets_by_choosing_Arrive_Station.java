...
public class C028_User_can_filter_tickets_by_choosing_Arrive_Station extends TestBase {

    @Test(dataProvider = "getDataForTest", description = "Người dùng có thể lọc vé đã mua theo ga đến")
    public void TC01(Hashtable<String, String> data) {
        ...
        logStep = TestReporter.logStepInfo(logMethod, "Bước #5: Lọc theo ga đến");
        ...
        if (data.get("ArriveStation").equals(data.get("ArriveStationFilter"))) {
