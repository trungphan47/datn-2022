...
public class C027_User_can_filter_tickets_by_entering_incorrect_Depart_Date_format extends TestBase {

    @Test(dataProvider = "getDataForTest", description = "Người dùng có thể lọc vé đã mua theo ngày khởi hành")
    public void TC01(Hashtable<String, String> data) {
        ...
        logStep = TestReporter.logStepInfo(logMethod, "Bước #5: Lọc theo ngày khởi hành");
